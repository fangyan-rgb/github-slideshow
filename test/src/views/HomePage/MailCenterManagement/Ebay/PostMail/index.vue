...
export default {
    ...
    methods: {
        ...
        initData() {
            ...
            if( this.$route.query.type === 'CustomerEvaluationReview' ){
                this.sendForm = {
                    ...this.sendForm,
                    account_id: this.$route.query.account_id,
                    receive_email: this.$route.query.customer_email,
                    type: '3',
                    inbox_id: this.$route.query.inbox_id,
            ...
            if( this.$route.query.type === 'CustomerReviewsFeedBack' ){
                this.sendForm = {
                    ...this.sendForm,
                    account_id: this.$route.query.account_id,
                    receive_email: this.$route.query.customer_email,
            ...
            if( this.$route.query.type === 'OrderListManagement' ){
                this.sendForm = {
                    ...this.sendForm,
                    account_id: this.$route.query.account_id,
                    receive_email: this.$route.query.email,
                    order_id: this.$route.query.order_id
                };
                // 加载信息
                this.loadInfo();
            ...
            if( this.$route.query.type === 'OrderInformation' ){
                this.sendForm = {
                    ...this.sendForm,
                    account_id: this.$route.query.account_id,
                    receive_email: this.$route.query.email,
            ...
            this.$refs.sendForm.validate((valid) => {
                if (valid) {
                    let obj = {
                        ...
                        sender_email: this.sendForm.sender_email,
                        account_id: this.sendForm.account_id,
