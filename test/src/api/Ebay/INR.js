...
export function getMainList(params = {}) {
    params = {...params};
    return http.getAjax('/ebay/ebay_inquiry/get_list', params);
}

export function getLogs(params = {}) {
    params = {...params};
    return http.getAjax('/ebay/ebay_inquiry/log', params);
}

export function saveKefu(params = {}) {
    params = {...params};
    return http.getAjax('/ebay/ebay_inquiry/update_customer', params);
}
...
export function dataOutput(params = {}) {
    ...
    window.open('/api/ebay/ebay_inquiry/get_download?' + str, '_self');
}
